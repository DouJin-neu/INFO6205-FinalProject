...
public class QuickSort_DualPivot<X extends Comparable<X>> extends QuickSort<X> {
    ...
    public class Partitioner_DualPivot implements Partitioner<X> {
         ...
         */
        public List<edu.neu.coe.info6205.sort.linearithmic.Partition<X>> partition(
            edu.neu.coe.info6205.sort.linearithmic.Partition<X> partition) {
            ...
            List<edu.neu.coe.info6205.sort.linearithmic.Partition<X>> partitions = new ArrayList<>();
            partitions.add(new edu.neu.coe.info6205.sort.linearithmic.Partition<>(xs, lo, lt));
            partitions.add(new edu.neu.coe.info6205.sort.linearithmic.Partition<>(xs, lt + 1, gt));
